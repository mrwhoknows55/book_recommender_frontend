        ...
        <div className="forms-container">
          ...
          <div className="input-field">
            ...
            <input
              ...
              onClick={(e) => handleInput2(e)} 
            />
          </div>

              <input type="submit" value="Sign in" className="btn solid" onClick={(e) => signIn(e)}/>
           ...
           <LockIcon className="icon" />
            <input
              ...
              onClick={(e) => handleInput4(e)}
            />
          </div>
             


              <input type="submit" className="btn" value="Sign up" onClick={(e) => signUp(e)}/>
        ...
        <div className="panels-container">
          <div className="panel left-panel">
            <div className="content">
              <h3>New here ?</h3>
              <p>
                Create a account with us and take benifits of our system.</p>
              <button
